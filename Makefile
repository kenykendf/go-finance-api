...
migrate-force-down: ## Force rollback migration
	migrate -path db/migrations/ -database postgres://studydso_user:studydso_pass@localhost:5432/gofinance_db?sslmode=disable force $(version)
